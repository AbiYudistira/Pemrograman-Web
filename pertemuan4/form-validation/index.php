        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if (!filter_var($url, FILTER_VALIDATE_URL)) {
                ...
                if ($password !== $cpassword) {
                    ...
                    $msg = "<div class='alert alert-success'> Resgister successfully completed. </div> ";
                    $full_name = "";
                    $email = "";
                    $url = "";
                    $password = "";
    ...
    <div class="wrapper">
        ...
        <form action="" method="post" class="form">
            ...
            <div class="input-field">
                ...
                <input type="password" name="cpassword" class="input" id="cpassword" placeholder="Enter your Password" value="<?php if (isset($_POST['submit'])) { echo $cpassword; } ?>">
            </div>
